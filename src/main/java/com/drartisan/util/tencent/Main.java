...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("扫描支付码:");
            String authCode = scan.next();

            ScanPayReqData scanPayReqData = new ScanPayReqData(authCode,"Test Goods","attach","od12355443",
                    1,"iphone","39.182.66.198", CommonUtil.getCurrentDatetimeStr(),"20170613143000","goodsTag");
